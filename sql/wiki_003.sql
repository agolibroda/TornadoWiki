...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `category` enum('inf','trm','nvg','tpl') NOT NULL DEFAULT 'inf',
...
--
ALTER TABLE `links`
  ADD CONSTRAINT `FK_links_published` FOREIGN KEY (`article_id`) REFERENCES `articles` (`article_id`);
...
ALTER TABLE `revisions`
  ...
  ADD CONSTRAINT `FK_article_sha_hash` FOREIGN KEY (`article_sha_hash`) REFERENCES `texts` (`article_sha_hash`),
...
--
ALTER TABLE `texts`
  ADD CONSTRAINT `FK_articles_published` FOREIGN KEY (`article_id`) REFERENCES `articles` (`article_id`);
